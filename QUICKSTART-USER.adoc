= Elixir Mcp Server — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/elixir-mcp-server
...
* https://github.com/hyperpolymath/elixir-mcp-server/issues — report bugs
