...
Replace all {{PLACEHOLDER}} values with your information:
  Elixir Mcp Server     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  elixir-mcp-server             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/elixir-mcp-server/security/advisories/new)
...
- This repository (`hyperpolymath/elixir-mcp-server`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/elixir-mcp-server/security/advisories)
...
When using Elixir Mcp Server, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/elixir-mcp-server/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/elixir-mcp-server/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/elixir-mcp-server/discussions) |
...
*Thank you for helping keep Elixir Mcp Server and its users safe.* 🛡️
