{
  description = "elixir-mcp-server - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 elixir-mcp-server development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P elixir-mcp-server.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/elixir-mcp-server $out/bin/  # Rust
            # cp bin/elixir-mcp-server $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/elixir-mcp-server";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-elixir-mcp-server" {
