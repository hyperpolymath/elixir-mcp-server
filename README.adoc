...
= elixir-mcp-server
image:https://img.shields.io/badge/OpenSSF-Best_Practices-green?logo=openssourcesecurity[OpenSSF Best Practices,link="https://www.bestpractices.dev/en/projects/new?repo_url=https://github.com/hyperpolymath/elixir-mcp-server"]
...
MPL-2.0 - see link:LICENSE[LICENSE] file for details
